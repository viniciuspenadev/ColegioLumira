...
$navItems = [
    ...
    [
        ...
        'children' => [
            ['label' => 'Mini-Maternal', 'href' => $link_prefix . '#classes', 'description' => '1 a 3 anos', 'image' => 'assets/images/mini-maternal-horta.webp'],
            ['label' => 'Maternal', 'href' => $link_prefix . '#classes', 'description' => '3 a 4 anos', 'image' => 'assets/images/maternal-vivencias.webp'],
            ['label' => 'Jardim 1', 'href' => $link_prefix . '#classes', 'description' => '4 anos a 5 anos', 'image' => 'assets/images/jardim-1-artes.webp'],
            ['label' => 'Jardim 2 (Pré)', 'href' => $link_prefix . '#classes', 'description' => '5 anos a 6 anos', 'image' => 'assets/images/criancas-fantasiadas-em-festa.webp']
        ]
    ],
    [
        'label' => 'Galeria',
